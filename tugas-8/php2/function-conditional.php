...
function balik($string){
    $Pstring = strlen($string);
    $stringReverse ="";
    for($i= $Pstring - 1; $i >=0; $i--){
        $stringReverse .= $string[$i];
    }; 
    return $stringReverse;
    };
    function reverseString($nama){
        $fanctionReverse = balik($nama);
        echo $fanctionReverse;
    };
   

// Hapus komentar di bawah ini untuk jalankan Code
reverseString("muhammad ridha");
